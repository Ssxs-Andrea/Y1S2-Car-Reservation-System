  ...
  <!-- MAKE THE MENU BAR STICKY -->
   ...
   <div class="menubar">
    ...
    <div class="dropdown-content">
      <a class="wording active sub" href="cupdatereservation.php">Update Reservation</a>
...
<?php
    ...
    if(isset($_POST['reserve'])){
      ...
      echo'<button class="outputlink2" onclick="print_current_page()">Click here to print your reservation details</button><br><br><br>';
    }
    else
    {
      ...
      if(isset($_POST['submit']) || (isset($_POST['check']))){
        ...
        //thus alert the user to input again
            ...
            echo"window.location='cupdatereservation.php';";
            echo"</script>";
        }
      }
    }  
