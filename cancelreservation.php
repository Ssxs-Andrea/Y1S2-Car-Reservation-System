  ...
  <div class="menubar">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <a class="wording active sub" href="cancelreservation.php">Cancel Reservation</a>
    </div>
  </div>
  <div class="dropdown">
...
<?php
    ...
    if(isset($_POST['yes']))
    {
      ...
      echo'<a class="outputlink" href="cancelreservation.php">Cancel Another New Reservation</a>';
    }
    ...
    elseif(isset($_POST['no']))
    {
      ...
      if(isset($_POST['submit'])){
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            echo"window.location='cancelreservation.php';";
            echo"</script>";
          }
      }
    }  
